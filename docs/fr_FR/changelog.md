...
- 30/09/2020 : V2.0.0 (Bêta)
	...
	- [x] Modification de la mise à jour des informations des capteurs RF (Info reste enregistré quand un autre capteur se déclenche)
...
- 21/08/2020 : V2.0.0 (Bêta)
    ...
    - [x] Ajout d'un systeme de sauvgarde des données de conso du POW par mois et annees
    ...
    - [x] Déplacement des logs détaillés dans un fichier .txt, pour plus de visibilitée en cas d'erreur
...
- 17/11/2019 : V1.1 (Bêta) (MISE A JOUR DES DEPENDANCES OBLIGATOIRE !! + Resynchronisation obligatoire )
	...
	- [x] Refonte complète du script, passage en POO pour une meilleur gestion du moteur du plugin.
	...
	- [x] Voltage
	- [x] POW
	- [x] Ajout de la compatibilitée des ifan02 et ifan03
